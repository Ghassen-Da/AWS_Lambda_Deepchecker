...
class DeepCheckerTest(unittest.TestCase):
    ...
    def test_deepchecker(self):
        expected_data="""TheDeepChecker: deep_checker_result Logs - WARNING - Conv. layer activation conv2d_7/relu are considered unstable with std of 0.28929210100820324 far from [0.5, 2.0]
